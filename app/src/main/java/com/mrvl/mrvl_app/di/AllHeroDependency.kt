...
import com.mrvl.mrvl_app.presentation.component.main.model.HeroMapperDomainToPresentation
...
class AllHeroModule {
    ...
    @Provides
    @FragmentScope
    fun provideMapper(mapper: HeroMapperDomainToPresentation): Mapper<DataDomain, DataPresentation> = mapper
}